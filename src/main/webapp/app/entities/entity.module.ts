...
@NgModule({
  imports: [
    RouterModule.forChild([
      ...
      {
        path: 'property',
        loadChildren: () => import('./property/property.module').then(m => m.JhipsterSampleApplicationPropertyModule),
      },
      {
        path: 'category',
      ...
      {
        path: 'business',
        loadChildren: () => import('./business/business.module').then(m => m.JhipsterSampleApplicationBusinessModule),
      },
      {
        path: 'employee',
