...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.mycompany.myapp.domain.Property.class.getName() + ".categories");
            createCache(cm, com.mycompany.myapp.domain.Category.class.getName());
            createCache(cm, com.mycompany.myapp.domain.Category.class.getName() + ".properties");
            createCache(cm, com.mycompany.myapp.domain.Business.class.getName());
